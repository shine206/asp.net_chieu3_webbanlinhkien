<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Rule.aspx.cs" MasterPageFile="~/Site.Master" Inherits="WebBanLinhKien.Rule" %>

<asp:Content ContentPlaceHolderID="ProductContent" ID="ruleContent" runat="server">
    <div class="breadcrumb">
        <div class="container">
            <ol class="list-unstyled list-inline">
                ...
                <li>
                    <span class="current" itemprop="item"><b>Điều khoản</b></span>
                </li>
            </ol>
        </div>
    </div><!-- End Breadcrumb -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
                    <h1 class="defaultPageTitle">Điều khoản</h1>
